...
namespace OBD2
{
    public class DiagnosticTroubleCode
    {
        ...
        /// </summary>
        public VehicleComputer Computer { get; private set; }
        ...
        {
            char codeLetter = elm327code[0];
            string prependedCode = string.Empty;
            switch (codeLetter)
            {
